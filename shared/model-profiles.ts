// 模型规格档案表：按模型 id 前缀匹配常见模型的上下文窗口与最大输出。
// 第三方 OpenAI 兼容目录（vLLM/Ollama/网关）普遍不上报 context/maxTokens，
...
// 按 2025 主流模型公开规格整理；前缀匹配不区分大小写。
export const MODEL_PROFILES: ProfileEntry[] = [
  // OpenAI（当前代）
  { prefix: 'gpt-5.6', profile: { contextWindow: 400000, maxTokens: 128000 } },
  { prefix: 'gpt-5.5', profile: { contextWindow: 400000, maxTokens: 128000 } },
  { prefix: 'gpt-5.4', profile: { contextWindow: 400000, maxTokens: 128000 } },
  { prefix: 'gpt-5', profile: { contextWindow: 400000, maxTokens: 128000 } },
  { prefix: 'o4-mini', profile: { contextWindow: 200000, maxTokens: 100000 } },
  { prefix: 'o3', profile: { contextWindow: 200000, maxTokens: 100000 } },
  { prefix: 'gpt-4.1', profile: { contextWindow: 1048576, maxTokens: 32768 } },
  { prefix: 'gpt-4.5', profile: { contextWindow: 128000, maxTokens: 16384 } },
  { prefix: 'gpt-4o', profile: { contextWindow: 128000, maxTokens: 16384 } },
  { prefix: 'gpt-4-turbo', profile: { contextWindow: 128000, maxTokens: 4096 } },
  { prefix: 'gpt-4', profile: { contextWindow: 8192, maxTokens: 8192 } },
  { prefix: 'codex', profile: { contextWindow: 262144, maxTokens: 16384 } },
  // Anthropic
  { prefix: 'claude-opus-4', profile: { contextWindow: 200000, maxTokens: 64000 } },
  { prefix: 'claude-sonnet-4', profile: { contextWindow: 200000, maxTokens: 64000 } },
  { prefix: 'claude-opus-4.5', profile: { contextWindow: 1000000, maxTokens: 64000 } },
  { prefix: 'claude-sonnet-4.5', profile: { contextWindow: 1000000, maxTokens: 64000 } },
  { prefix: 'claude-3.7', profile: { contextWindow: 200000, maxTokens: 64000 } },
  { prefix: 'claude-3.5', profile: { contextWindow: 200000, maxTokens: 64000 } },
  { prefix: 'claude-3', profile: { contextWindow: 200000, maxTokens: 4096 } },
  { prefix: 'claude', profile: { contextWindow: 200000, maxTokens: 64000 } },
  // Google
  { prefix: 'gemini-3', profile: { contextWindow: 1048576, maxTokens: 65536 } },
  { prefix: 'gemini-2.5', profile: { contextWindow: 1048576, maxTokens: 65536 } },
  { prefix: 'gemini-2.0', profile: { contextWindow: 1048576, maxTokens: 8192 } },
  { prefix: 'gemini-1.5', profile: { contextWindow: 1048576, maxTokens: 8192 } },
  ...
  { prefix: 'glm-4v', profile: { contextWindow: 128000, maxTokens: 8192 } },
  ...
  { prefix: 'grok-4', profile: { contextWindow: 262144, maxTokens: 32768 } },
 ...
 * vLLM/Ollama 的模型 id 常带组织前缀（Qwen/Qwen3-8B），除完整 id 外
 * 也匹配斜杠后的基础模型名。 */
